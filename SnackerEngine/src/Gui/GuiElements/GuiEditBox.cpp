...
namespace SnackerEngine
{
	...
	GuiEditBox::GuiEditBox(const Vec2i& position, const Vec2i& size, const std::string& text, const Font& font, const double& fontSize)
		: GuiTextBox(position, size, text, font, fontSize) {}
