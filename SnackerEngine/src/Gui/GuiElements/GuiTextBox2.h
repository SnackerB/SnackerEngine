...
namespace SnackerEngine
{
	...
	struct GuiStyle;
	//--------------------------------------------------------------------------------------------------
	class GuiDynamicTextBox2 : public GuiElement2
	{
	public:
	...
	protected:
		...
		GuiDynamicTextBox2(const Vec2i& position, const Vec2i& size, const GuiElement2::ResizeMode& resizeMode, std::unique_ptr<DynamicText>&& text,
			const Color4f& textColor, const Color4f& backgroundColor, const TextBoxMode& textBoxMode, const double& singleLine);

	public:
		/// Constructor
		GuiDynamicTextBox2(const Vec2i& position, const Vec2i& size, const GuiElement2::ResizeMode& resizeMode,
		...
		GuiDynamicTextBox2(const std::string& text, const GuiStyle& style);
		GuiDynamicTextBox2(const std::string& text, const double& fontSize, const GuiStyle& style);
		/// Copy and Move constructors
		GuiDynamicTextBox2(const GuiDynamicTextBox2& other) noexcept;
		GuiDynamicTextBox2(GuiDynamicTextBox2&& other) noexcept;
		/// Copy and Move assignment operators
		GuiDynamicTextBox2& operator=(const GuiDynamicTextBox2& other) noexcept;
		GuiDynamicTextBox2& operator=(GuiDynamicTextBox2&& other) noexcept;
		/// Setter and Getters
		...
		void setSingleLine(const bool& singleLine);
	...
	//--------------------------------------------------------------------------------------------------
	class GuiEditTextBox2 : public GuiDynamicTextBox2
	{
	...
	public:
		...
		/// Constructors using GuiStyle
		GuiEditTextBox2(const std::string& text, const GuiStyle& style);
		GuiEditTextBox2(const std::string& text, const double& fontSize, const GuiStyle& style);
		/// Copy and Move constructors
		GuiEditTextBox2(const GuiEditTextBox2& other) noexcept;
		GuiEditTextBox2(GuiEditTextBox2&& other) noexcept;
		/// Copy and Move assignment operators
		GuiEditTextBox2& operator=(const GuiEditTextBox2& other) noexcept;
		GuiEditTextBox2& operator=(GuiEditTextBox2&& other) noexcept;
