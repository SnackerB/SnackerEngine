...
namespace SnackerEngine
{
	...
	protected:
		...
		Model parseTextCharacters(const std::u8string& text, const Font& font, const double& fontSize, const double& textWidth, const Alignment& alignment = Alignment::LEFT);
		/// Constructs the model using the given parameters and using parse mode 'WORD_BY_WORD'
		Model parseTextWordByWord(const std::u8string& text, const Font& font, const double& fontSize, const double& textWidth, const Alignment& alignment = Alignment::LEFT);
		/// Constructs the model from the text member variable
		virtual void constructModel(const std::u8string& text, const Font& font, const double& fontSize, const double& textWidth, const ParseMode& parseMode = ParseMode::WORD_BY_WORD, const Alignment& alignment = Alignment::LEFT);
	public:
		/// Default constructor
		StaticText2();
		/// Constuctor using a string and various parameters
		StaticText2(const std::u8string& text, const Font& font, const double& fontSize, const double& textWidth, const ParseMode& parseMode = ParseMode::WORD_BY_WORD, const Alignment& alignment = Alignment::LEFT);
	};
	//--------------------------------------------------------------------------------------------------
	...
	class DynamicText2 : public StaticText2
	{
	protected:
	...
	public:
		...
		DynamicText2();
		/// Constuctor using a string and various parameters
		DynamicText2(const std::u8string& text, const Font& font, const double& fontSize, const double& textWidth, const ParseMode& parseMode = ParseMode::WORD_BY_WORD, const Alignment& alignment = Alignment::LEFT);
		/// Getters
