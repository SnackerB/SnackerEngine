...
namespace SnackerEngine
{
	...
	class ListLayout2 : public GuiLayout2
	{
	public:
	...
	public:
		/// Constructor
		ListLayout2(const float& verticalOffset, const float& leftBorder, const float& scrollSpeed,
		...
		ListLayout2(const GuiStyle& style);
	};
