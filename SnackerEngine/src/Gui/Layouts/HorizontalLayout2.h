...
namespace SnackerEngine
{
	...
	class HorizontalLayout2 : public GuiLayout2
	{
	private:
	...
	public:
		...
		HorizontalLayout2(const HorizontalLayout2& other) noexcept;
		HorizontalLayout2& operator=(const HorizontalLayout2& other) noexcept;
		/// Move constructor and assignment operator
		HorizontalLayout2(HorizontalLayout2&& other) noexcept;
		HorizontalLayout2& operator=(HorizontalLayout2&& other) noexcept;
	};
