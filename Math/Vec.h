...
namespace SnackerEngine
{
	...
	//------------------------------------------------------------------------------------------------------
	template<typename T2>
	std::string to_string(const Vec2<T2>& val)
	{
		std::ostringstream result{};
		result << "(" << to_string(val.x) << ", " << to_string(val.y) << ")";
		return result.str();
	}
	//------------------------------------------------------------------------------------------------------
	template<typename T2>
	std::string to_string(const Vec3<T2>& val)
	{
		std::ostringstream result{};
	...
	//------------------------------------------------------------------------------------------------------
	template<typename T2>
	std::string to_string(const Vec4<T2>& val)
	{
		std::ostringstream result{};
