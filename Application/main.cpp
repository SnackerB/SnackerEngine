...
public:
	...
	TextDemo()
		...
		Text(u8"Hello Wörld! This is a test. And now we have a reallyreallyreallyreallylongword!ü yeah", font, fontSize, textWidth, SnackerEngine::StaticText::ParseMode::WORD_BY_WORD),
