...
public:
		...
		: guiManager(3), increaseIntHandle{}, decreaseIntHandle{}, counter(0), textBox{}
	{
		...
		*/
		...
		auto listLayoutRef = guiManager.registerLayout(parentWindow, SnackerEngine::ListLayout(20.0, 20.0, SnackerEngine::ListLayout::ListLayoutResizeMode::RESIZE_WIDTH_IF_POSSIBLE));
